    ...
    <div>
      ...
      <div class="container content">
        ...
        <article class="service-page">
          <div class="service-page__number">Sales training</div>
        ...
        <article class="service-page">
          <div class="service-page__number">Sales Recruitment</div>
          <div class="service-page__content">
        ...
        <article class="service-page">
          <div class="service-page__number">Sales Synergy</div>
          <div class="service-page__content">
        ...
        <article class="service-page">
          <div class="service-page__number">Outsourced Sales Management</div>
          <div class="service-page__content">
        ...
        <article class="service-page">
          <div class="service-page__number">Sales Coaching</div>
          <div class="service-page__content">
